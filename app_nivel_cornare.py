...
nombre_estudiante = st.sidebar.text_input("Nombre del estudiante", "Aylin susana padierna ferrero")
codigo_estacion = st.sidebar.text_input("Código de estación", "44")
...
st.title(" El carmen del viboral ")
